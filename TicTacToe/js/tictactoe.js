...
function placeXOrO(squareNumber) {
    ...
    //to see if it contains the square number clikced on.
...
function checkWinConditions() {
    ...
    function arrayIncludes(squareA, squareB, squareC) {
        ...
        //true is returned and our else if condition executed the drawLine() function.
...
function audio(audioURL) {
    //We create a new audio object an dpass the path as a parameter.
...
function drawWinLine(coordX1, coordY1, coordX2, coordY2) {
    ...
    function animateLineDrawing() {
        ...
        //This method clears content from t he last loop iteration
